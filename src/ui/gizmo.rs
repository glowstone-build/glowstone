...
/// Three RGB axis handles at the pivot; grab one to translate along that world axis.
...
impl GizmoGroup for MoveGizmo {
    ...
    fn invoke(&self, h: Handle) -> GizmoStart {
        ...
        GizmoStart { kind: TransformKind::Move, axis }
    }
}
...
impl GizmoGroup for RotateGizmo {
    ...
    fn invoke(&self, h: Handle) -> GizmoStart {
        ...
        GizmoStart { kind: TransformKind::Rotate, axis }
    }
}
...
impl GizmoGroup for ScaleGizmo {
    ...
    fn invoke(&self, h: Handle) -> GizmoStart {
        ...
        GizmoStart { kind: TransformKind::Scale, axis }
    }
}
